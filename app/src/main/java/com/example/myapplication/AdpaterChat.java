...
public class AdpaterChat extends RecyclerView.Adapter<com.example.myapplication.AdpaterChat.Myholder> {
    ...
    public AdpaterChat(Context context, List<ModelChat> list, String imageurl) {
